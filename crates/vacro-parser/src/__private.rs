...
/// Source span support for values generated by `vacro-parser`.
pub trait VacroSpanned {
    /// Returns the source span recorded for the parsed value.
    fn span(&self) -> ::proc_macro2::Span;

    /// Creates a `syn::Error` located at this parsed value.
