...
#[doc_i18n]
/// @cn 即时解析宏：在现有的解析逻辑中快速消费 `TokenStream`
/// @en On-the-fly parsing macro: Quickly consume a `TokenStream` within existing parsing logic
///
/// ::: @cn
///
...
#[doc_i18n]
/// @cn 结构体定义宏：定义一个新的 AST 节点并自动实现 `syn::parse::Parse`
/// @en Struct definition macro: Define a new AST node and implement `syn::parse::Parse` automatically
///
/// ::: @cn
